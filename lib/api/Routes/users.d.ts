        ...
        (id: '@me'): {
            ...
            applications(applicationId: string): {
                'role-connection': {
                    ...
                    put(args: RestArguments<ProxyRequestMethod.Put, RESTPutAPICurrentUserApplicationRoleConnectionJSONBody>): Promise<RESTPutAPICurrentUserApplicationRoleConnectionResult>;
                };
            };
        };
    };
