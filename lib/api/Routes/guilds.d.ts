        ...
        (id: string): {
            ...
            'auto-moderation': {
                rules: {
                    ...
                    post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIAutoModerationRuleJSONBody>): Promise<RESTPostAPIAutoModerationRuleResult>;
                    (id: string): {
                        get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<RESTGetAPIAutoModerationRuleResult>;
                        patch(args: RestArguments<ProxyRequestMethod.Post, RESTPatchAPIAutoModerationRuleJSONBody>): Promise<RESTPatchAPIAutoModerationRuleResult>;
            ...
            channels: {
                ...
                patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildChannelPositionsJSONBody>): Promise<RESTPatchAPIGuildChannelPositionsResult>;
            };
            members: {
            ...
            threads: {
                active: {
                    get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<Identify<RESTGetAPIGuildThreadsResult & {
            ...
            widget: {
                ...
                patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildWidgetSettingsJSONBody>): Promise<RESTPatchAPIGuildWidgetSettingsResult>;
            };
            'widget.json': {
            ...
            'welcome-screen': {
                ...
                patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildWelcomeScreenJSONBody>): Promise<RESTPatchAPIGuildWelcomeScreenResult>;
            };
            emojis: {
            ...
            stickers: {
                ...
                post(args: RestArguments<ProxyRequestMethod.Post, Omit<RESTPostAPIGuildStickerFormDataBody, 'file'>, {}, OmitInsert<RawFile, 'key', {
                    key: 'file';
            ...
            'scheduled-events': {
                ...
                post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildScheduledEventJSONBody>): Promise<RESTPostAPIGuildScheduledEventResult>;
                (id: string): {
                    ...
                    patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildScheduledEventJSONBody>): Promise<RESTPatchAPIGuildScheduledEventResult>;
                    delete(args?: RestArguments<ProxyRequestMethod.Delete>): Promise<RESTDeleteAPIGuildScheduledEventResult>;
                    users: {
                        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildScheduledEventUsersQuery>): Promise<RESTGetAPIGuildScheduledEventUsersResult>;
                    };
                };
            };
            templates: {
