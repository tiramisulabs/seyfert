...
export interface ChannelRoutes {
    channels(id: string): {
        ...
        threads: {
            post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelThreadsJSONBody | RESTPostAPIGuildForumThreadsJSONBody>): Promise<RESTPostAPIChannelThreadsResult>;
            archived: {
                public: {
                    get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelThreadsArchivedQuery>): Promise<RESTGetAPIChannelThreadsArchivedPublicResult>;
                };
                private: {
                    get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelThreadsArchivedQuery>): Promise<RESTGetAPIChannelThreadsArchivedPrivateResult>;
                };
            };
        };
        ...
        messages: {
            ...
            'bulk-delete': {
                post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelMessagesBulkDeleteJSONBody>): Promise<RESTPostAPIChannelMessagesBulkDeleteResult>;
            };
            (id: string): {
                ...
                threads: {
                    post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelMessagesThreadsJSONBody>): Promise<RESTPostAPIChannelMessagesThreadsResult>;
                };
                crosspost: {
                ...
                reactions: {
                    ...
                    (emoji: string): {
                        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelMessageReactionUsersQuery>): Promise<RESTGetAPIChannelMessageReactionUsersResult>;
