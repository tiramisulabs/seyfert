...
const customWorkerManager = new WorkerManager(customWorkerManagerOptions);
expectType<Promise<ResolvedWorkerShardTopology>>(customWorkerManager.resolveShardTopology());
